...
**ALWAYS_ON** : requires paid Heroku account, set it to 'true' to keep the bot alive all the time ( otherwise it will be kept alive from early morning till late night Heroku server time ), you have to set KEEP_ALIVE_URL to your bot's full home page link for ALWAYS_ON to work ( see also the explanation of KEEP_ALIVE_URL config var )  
