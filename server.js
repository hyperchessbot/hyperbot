...
const queryPlayingInterval = parseInt(process.env.QUERY_PLAYING_INTERVAL || "5")
...
const bookSpeeds = (process.env.BOOK_SPEEDS || "bulet,blitz,rapid,classical,correspondence").split(",")
envKeys.push('BOOK_SPEEDS')
const logApi = isEnvTrue('LOG_API')
envKeys.push('LOG_API')
const challengeInterval = parseInt(process.env.CHALLENGE_INTERVAL || "5")
envKeys.push('CHALLENGE_INTERVAL')
const challengeTimeout = parseInt(process.env.CHALLENGE_TIMEOUT || "1")
